...
const Footer = () => (
  <Container as="footer" fluid className="footer">
    <Row xs={1} sm={2} xl={3}>
      <Col sm={12} md={8} xl={6} className="d-flex align-items-center">
        ...
        <div className="footer-about-me">
          <p>
            I am a Full Stack Web Developer with experience in many{" "}
            <Link to="/about">languages and library's</Link>. I have created
            many Front end and Back end websites that are built with best
            practices.
          </p>
        </div>
      </Col>
      ...
      <Col sm={6} md={12} xl={3} as="dl" className="footer-social">
        <div>
          <dt>
            <a
              href="https://github.com/adrianbparra"
              target="_blank"
              rel="noreferrer"
            >
              <FaGithubSquare />
          ...
          <dd>See what Im working on</dd>
        </div>
        <div>
          <dt>
            <a
              href="https://www.linkedin.com/in/adrian-parra/"
              target="_blank"
              rel="noreferrer"
            >
              <FaLinkedin />
          ...
          <dd>Connect with me</dd>
        </div>
        <div>
          <dt>
            <a
              href="https://twitter.com/Adrian_B_Parra"
              target="_blank"
              rel="noreferrer"
            >
              <FaTwitterSquare />
    ...
    <Row xs={1} className="text-center">
      <small>
        Created by <Link to="/">Adrian Parra</Link>, ©{" "}
