        ...
        <Navbar.Brand className="title" as={Link} to="/">
          ...
          >
            <g id="Logo">
              <path
                id="a"
                d="M2 117L35.8182 5L47.0909 33.4308L41.021 55.8308H57L64 71.3385H35.8182L21.0769 117H2Z"
                fill="black"
              />
              <path
                id="p"
                d="M85.8058 118.5L36.9062 4.11495L118.5 4.11495L118.5 22.5L81 53.7146L74.5 39L99.5 18L63.8166 18.6482L107 118.5L85.8058 118.5Z"
                fill="black"
              />
            </g>
          </svg>
