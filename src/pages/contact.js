        ...
        .then(r => {
          if (!r.ok) {
            ...
            handleServerResponse(
              true,
              "Thank you for your email, I look foward to working with you.",
              form,
            )
          }
        })
  ...
  return (
    <Layout page={"contact"}>
      ...
      <Container fluid className="header">
        <h1>Get in Touch</h1>
        <p>
          Send me a message or details of the project you would like me to be a
          part of.
        </p>
      </Container>
      ...
      <Container fluid className="form">
        <Form id="contact" onSubmit={handleSubmit}>
          ...
          <Button
            type="submit"
            disabled={buttonDisabled | serverState.submitting}
          >
            {" "}
            Submit{" "}
          </Button>
